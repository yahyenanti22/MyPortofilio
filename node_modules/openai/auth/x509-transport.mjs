...
import { createX509Transport as createCapability, registerX509Transport, sendX509Request, } from "../internal/auth/x509-transport-capability.mjs";
import { exchangeX509Token } from "../internal/auth/x509-token-exchange.mjs";
import { isRetryableX509TransportFailure } from "../internal/auth/x509-transport-registry.mjs";
import { markTransientX509ConnectionError, rememberX509Credential } from '../internal/auth/x509-transport-state.mjs';
...
class OwnedX509Credential {
    constructor(dispatcher) {
        ...
        __classPrivateFieldSet(this, _OwnedX509Credential_dispatcher, dispatcher, "f");
        Object.freeze(this);
    }
    /** Closes this credential's owned transport once all in-flight requests have drained. */
    close() {
        __classPrivateFieldSet(this, _OwnedX509Credential_closing, __classPrivateFieldGet(this, _OwnedX509Credential_closing, "f") ?? __classPrivateFieldGet(this, _OwnedX509Credential_dispatcher, "f").close(), "f");
        return __classPrivateFieldGet(this, _OwnedX509Credential_closing, "f");
    }
}
...
export function createX509Transport(options) {
    ...
    registerX509Transport(capability, {
        ...
        exchange: async (identityProviderId, serviceAccountId, signal) => await exchangeX509Token({
...
export function fromX509(options) {
...
//# sourceMappingURL=x509-transport.mjs.map