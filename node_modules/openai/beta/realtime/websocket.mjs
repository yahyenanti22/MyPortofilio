import { assertBedrockWebSocketOrigin } from "../../internal/bedrock.mjs";
import { OpenAI } from "../../index.mjs";
import { OpenAIError } from "../../error.mjs";
import { OpenAIRealtimeEmitter, buildRealtimeURL, isAzure, parseRealtimeEvent } from "./internal-base.mjs";
...
function createAzureWebSocket(url, apiKey, isBearerToken, protocols) {
    if (!supportsWebSocketRequestHeaders()) {
        throw new OpenAIError('Azure OpenAI Realtime credentials require a WebSocket transport that supports request headers; use openai/realtime/ws or a server-side authentication proxy.');
    }
    if (!apiKey) {
