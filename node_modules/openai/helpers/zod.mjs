...
import { makeParseableResponseFormat, makeParseableTextFormat, makeParseableTool, parseResponseFormatContent, } from "../lib/parser.mjs";
...
import { forEachJSONSchemaChild, toStrictJsonSchema } from "../lib/transform.mjs";
import { hasOwn } from "../internal/utils/values.mjs";
import { assertJSONSerializableSchema, assertSupportedZodV3Schema } from "./zod-v3-strict-schema.mjs";
...
function zodV3ToJsonSchema(schema, options) {
    assertSupportedZodV3Schema(schema, options.schemaDefinitions);
