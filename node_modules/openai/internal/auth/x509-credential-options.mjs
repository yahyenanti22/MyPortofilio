...
import { isX509WorkloadIdentity } from "./x509-workload-identity-auth.mjs";
import { findX509Credential } from './x509-transport-state.mjs';
/** Validates one privately registered credential and suppresses ambient legacy authentication. */
export function normalizeX509CredentialOptions(options) {
...
export function prepareX509ClientClone(inherited, overrides, credential, currentlyX509) {
