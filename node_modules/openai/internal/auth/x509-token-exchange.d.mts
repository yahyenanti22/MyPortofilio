import type { X509ExchangedToken, X509Transport } from "./x509-transport-registry.mjs";
export type { X509ExchangedToken } from "./x509-transport-registry.mjs";
...
//# sourceMappingURL=x509-token-exchange.d.mts.map