...
export function createCanonicalResponseContext() {
    return {
...
export function getOutputText(context, output) {
...
export function ensureCanonicalOutputText(context, snapshot) {
...
export function cloneResponse(context, response) {
...
export function updateCachedOutputTextLength(context, output, outputIndex, previousText, nextText) {
...
export function updateOutputText(context, snapshot, outputIndex, previousText, nextText, contentIndex) {
