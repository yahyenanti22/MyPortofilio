...
class EventEmitter {
    ...
    emitted(event) {
        return new Promise((resolve, reject) => {
            ...
            if (event !== 'error') {
                tslib_1.__classPrivateFieldGet(this, _EventEmitter_instances, "m", _EventEmitter_onceForEmitted).call(this, 'error', onError);
            }
            tslib_1.__classPrivateFieldGet(this, _EventEmitter_instances, "m", _EventEmitter_onceForEmitted).call(this, event, onEvent);
        });
    }
    _emit(event, ...args) {
        const listeners = tslib_1.__classPrivateFieldGet(this, _EventEmitter_listeners, "f")[event];
