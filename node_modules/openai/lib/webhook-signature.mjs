 ...
 * @internal
 */
export function webhookSignatureRequiresSigning(signatureHeader) {
 ...
 * @internal
 */
export async function verifyWebhookSignature(payload, signatureHeader, timestamp, webhookId, secret, tolerance) {
