...
import { DataRetention, DataRetentionUpdateParams, ProjectDataRetention } from "./data-retention.js";
import * as HostedToolPermissionsAPI from "./hosted-tool-permissions.js";
import { HostedToolPermissionUpdateParams, HostedToolPermissions, ProjectHostedToolPermissions } from "./hosted-tool-permissions.js";
import * as ModelPermissionsAPI from "./model-permissions.js";
import { ModelPermissionUpdateParams, ModelPermissions, ProjectModelPermissions, ProjectModelPermissionsDeleted } from "./model-permissions.js";
...
import { RoleCreateParams, RoleDeleteParams, RoleDeleteResponse, RoleListParams, RoleRetrieveParams, RoleUpdateParams, Roles } from "./roles.js";
import * as SpendAlertsAPI from "./spend-alerts.js";
import { ProjectSpendAlert, ProjectSpendAlertDeleted, ProjectSpendAlertsPage, SpendAlertCreateParams, SpendAlertDeleteParams, SpendAlertListParams, SpendAlertRetrieveParams, SpendAlertUpdateParams, SpendAlerts } from "./spend-alerts.js";
import * as SpendLimitAPI from "./spend-limit.js";
import { ProjectSpendLimit, ProjectSpendLimitDeleted, SpendLimit, SpendLimitUpdateParams } from "./spend-limit.js";
import * as GroupsAPI from "./groups/groups.js";
import { GroupCreateParams, GroupDeleteParams, GroupDeleteResponse, GroupListParams, GroupRetrieveParams, Groups, ProjectGroup, ProjectGroupsPage } from "./groups/groups.js";
...
export type ProjectResidency = 'GLOBAL' | 'US_STORAGE_PROCESSING' | 'EU_STORAGE_PROCESSING' | 'JP_STORAGE' | 'KR_STORAGE' | 'CA_STORAGE' | 'SG_STORAGE' | 'IN_STORAGE' | 'AU_STORAGE' | 'GB_STORAGE' | 'AE_STORAGE' | 'AE_STORAGE_PROCESSING';
...
export declare namespace Projects {
    export { type Project as Project, type ProjectResidency as ProjectResidency, type ProjectsPage as ProjectsPage, type ProjectCreateParams as ProjectCreateParams, type ProjectUpdateParams as ProjectUpdateParams, type ProjectListParams as ProjectListParams, };
    ...
    export { SpendLimit as SpendLimit, type ProjectSpendLimit as ProjectSpendLimit, type ProjectSpendLimitDeleted as ProjectSpendLimitDeleted, type SpendLimitUpdateParams as SpendLimitUpdateParams, };
