...
export declare class Usage extends APIResource {
     ...
     * ```
     */
    fileSearchCalls(query: UsageFileSearchCallsParams, options?: RequestOptions): APIPromise<UsageFileSearchCallsResponse>;
    /**
     ...
     * ```
     */
    webSearchCalls(query: UsageWebSearchCallsParams, options?: RequestOptions): APIPromise<UsageWebSearchCallsResponse>;
}
/**
 * The unit of the `quantity` value. If no single supported unit applies to the
 * result, this field is `null`.
 */
export type CostQuantityUnit = (string & {}) | 'tokens' | '1000_tokens' | 'duration_seconds' | 'duration_minutes' | 'duration_hours' | 'gibibyte_hours' | 'images' | 'characters';
...
export declare namespace UsageAudioSpeechesResponse {
    ...
    namespace Data {
         ...
         */
        interface OrganizationUsageFileSearchesResult {
            /**
         ...
         */
        interface OrganizationUsageWebSearchesResult {
            /**
...
export declare namespace UsageFileSearchCallsResponse {
    interface Data {
        end_time: number;
        object: 'bucket';
        results: Array<Data.OrganizationUsageCompletionsResult | Data.OrganizationUsageEmbeddingsResult | Data.OrganizationUsageModerationsResult | Data.OrganizationUsageImagesResult | Data.OrganizationUsageAudioSpeechesResult | Data.OrganizationUsageAudioTranscriptionsResult | Data.OrganizationUsageVectorStoresResult | Data.OrganizationUsageCodeInterpreterSessionsResult | Data.OrganizationUsageFileSearchesResult | Data.OrganizationUsageWebSearchesResult | Data.OrganizationCostsResult>;
...
export declare namespace UsageWebSearchCallsResponse {
    interface Data {
        end_time: number;
        object: 'bucket';
        results: Array<Data.OrganizationUsageCompletionsResult | Data.OrganizationUsageEmbeddingsResult | Data.OrganizationUsageModerationsResult | Data.OrganizationUsageImagesResult | Data.OrganizationUsageAudioSpeechesResult | Data.OrganizationUsageAudioTranscriptionsResult | Data.OrganizationUsageVectorStoresResult | Data.OrganizationUsageCodeInterpreterSessionsResult | Data.OrganizationUsageFileSearchesResult | Data.OrganizationUsageWebSearchesResult | Data.OrganizationCostsResult>;
