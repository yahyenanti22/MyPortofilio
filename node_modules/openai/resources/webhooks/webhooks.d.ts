...
export declare namespace SafetyAlertCreatedWebhookEvent {
    interface Data {
        /**
...
export declare namespace SafetyOrgAlertCreatedWebhookEvent {
    interface Data {
        /**
         * The safety alert ID to pass to `GET /v1/safety/alerts/{id}`.
         */
